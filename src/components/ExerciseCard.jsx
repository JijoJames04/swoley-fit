...
export default function ExerciseCard(props) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-md bg-slate-950 p-4 sm:flex-wrap">
      <div className="flex flex-col gap-x-4 sm:flex-col sm:flex-wrap sm:items-center">
        <h4 className="hidden text-3xl font-semibold text-slate-400 sm:inline sm:text-4xl md:text-5xl">
          0{i + 1}
        </h4>
